            ...
            <div class="row">
                <div class="col-lg-3 col-md-3">
                    <div class="shop__sidebar">         
                        ...
                        <div class="row justify-content-left  mb-3">
                            ...
                            <?php 
                                $categories = $conn->query("SELECT * FROM `category_list` where delete_flag = 0 and shop_type_id=7 order by `name` asc ");
                                while($row = $categories->fetch_assoc()):
                                ?>
                ...
                <div class="container-fluid">
                    ...
                    <?php 
                            ...
                            $products = $conn->query("SELECT p.*, v.shop_name as vendor, c.name as `category` FROM `product_list` p inner join vendor_list v on p.vendor_id = v.id inner join category_list c on p.category_id = c.id where p.delete_flag = 0 and p.`shop_type_id` = 7 {$swhere} order by RAND()");
...
<script>
    $(function(){
        ...
        $('.cat_item').change(function(){
            ...
            location.href="./?page=products/trash_products&cids="+(ids.join(","))
        })
        ...
        $('#search-frm').submit(function(e){
            ...
            location.href="./?page=products/trash_products&"+q;
