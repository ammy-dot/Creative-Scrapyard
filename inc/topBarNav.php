        ...
        <div class=" d-flex justify-content-between w-100">
          ...
          <div>
            <?php if($_settings->userdata('id') > 0 && $_settings->userdata('login_type') ==3): ?>
              ...
              <!-- <span class="mx-2">Howdy, <?= !empty($_settings->userdata('username')) ? $_settings->userdata('username') : $_settings->userdata('username') ?></span>
              ...
              <div class="dropdown">
                ...
                <span class="mx-2"><img src="<?= validate_image($_settings->userdata('avatar')) ?>" class="img-thumbnail rounded-circle" alt="User Avatar" id="client-img-avatar">  <span class="mx-2">Howdy, <?php echo ucwords($_settings->userdata('firstname')) ?></span>
                </a>
            ...
            <?php else: ?>
              ...
              <a href="./register.php" class="mx-2 text-light text-decoration-none font-weight-bolder">Sign Up</a>
            <?php endif; ?>
          </div>
        </div>
      </nav>
<section style="margin-bottom:100px;">
      <nav class="main-header  navbar navbar-expand-md  border-0 text-sm bg-gradient-light shadow" id='top-Nav'>
        <div class="container ">
          
            <a href="./" class="navbar-brand">
               <img src="<?php echo base_url ?>uploads\Scrapyad.png" alt="Site Logo" class="brand-image  ">
            <span><?= $_settings->info('') ?></span>
            </a>
         

          <div class=" collapse navbar-collapse justify-content-center  order-3  " id="navbarCollapse">
            <!-- Left navbar links -->
            <ul class=" navbar-nav  ">
              <li class="nav-item">
              ...
              <li class="nav-item">
              <a href="#" class="nav-link <?= isset($page) && $page =='products' ? "active" : "" ?>">Products</a>
                  <ul class="dropdown">
                    <li><a href="./?page=products/treasure_products">Treasure Products</a></li>
                    <li><a href="./?page=products/trash_products">Trash Products</a></li>
                  </ul>
              </li>
              <li class="nav-item">
                <a href="./#about" class="nav-link <?= isset($page) && $page =='about' ? "active" : "" ?>">About Us</a>
              </li>
              <?php if($_settings->userdata('id') > 0 && $_settings->userdata('login_type') == 3): ?>
              <li class="nav-item">
                <?php 
          ...
          <div  class="order-1  order-md-3  navbar-nav navbar-no-expand ml-auto">
            <button class="navbar-light navbar-toggler border-0 text-sm" type="button" data-toggle="collapse" data-target="#navbarCollapse" aria-controls="navbarCollapse" aria-expanded="false" aria-label="Toggle navigation">
